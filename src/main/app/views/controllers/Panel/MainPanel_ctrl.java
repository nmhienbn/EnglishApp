...
import views.controllers.Games.*;
import views.controllers.GoogleTab.GoogleTab_ctrl;

import java.io.IOException;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

import static views.controllers.Panel.PanelButton.colorAdjust;
    ...
    protected void initialize() throws IOException {
        ...
        executorService.submit(() -> {
            game_tab = File_loader.getInstance().
                    fxml_loadTab("front_end/fxml/game.fxml", new GameTab_ctrl());
        });
